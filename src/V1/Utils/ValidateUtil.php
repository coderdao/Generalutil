...
class ValidateUtil
{
    ...
    private function checkResult($rule, $validate_data) {
        switch ($rule) {
            ...
            case 'int':
                ...
                break;
            case 'string':
                return filter_var($validate_data, FILTER_SANITIZE_STRING);
                break;
            case 'array':
    ...
    public static function notIn($rule, $data) {
        return !PubValidate::in($data, $rule);
    }
    ...
    public static function notBetween($rule, $data) {
        return !PubValidate::between($rule, $data);
    }
    ...
    public static function confirm($rule, $data) {
        return self::getData( $rule ) && $data == self::getData( $rule );
    }
